 ...
 * @author Guide Info
 */
public class MesProduitItemsController implements Initializable {
    ...
    private void Update(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("FormUpdateMesProduit.fxml"));
            Parent root = loader.load();
            FormUpdateMesProduitController controller = loader.getController();
